package bank.manager.ui.account_create;
...
public class CreateScreen extends JPanel {
    ...
    public CreateScreen(EditInterFace editInterFace, Map<String, Account> database) {
    ...
    public void initComponents() {
        ...
        lbl_title.setText("        Create Account");
        ...
        lbl_deposit.setText("Inital Deposit");
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                .addGroup(layout.createSequentialGroup()
                                        .addComponent(lbl_phone, GroupLayout.PREFERRED_SIZE, 120,
                                                GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(
                                                txt_phone, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(lbl_type, GroupLayout.PREFERRED_SIZE, 120,
                                                        GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(cmb_type, GroupLayout.PREFERRED_SIZE, 180,
                                                        GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(layout.createSequentialGroup()
                                                        .addComponent(lbl_id, GroupLayout.PREFERRED_SIZE, 120,
                                                                GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                                        .addComponent(txt_id, GroupLayout.PREFERRED_SIZE, 180,
                                                                GroupLayout.PREFERRED_SIZE))
                                                .addGroup(layout.createSequentialGroup()
                                                        .addComponent(lbl_name, GroupLayout.PREFERRED_SIZE, 120,
                                                                GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                                        .addComponent(txt_name, GroupLayout.PREFERRED_SIZE, 180,
                                                                GroupLayout.PREFERRED_SIZE))))
                                .addComponent(lbl_title, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE)
                                .addGroup(layout.createSequentialGroup()
                                        .addComponent(lbl_email, GroupLayout.PREFERRED_SIZE, 120,
                                                GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(
                                                txt_email, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE))
                                .addComponent(txt_status, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE)
                                .addGroup(layout.createSequentialGroup()
                                        .addComponent(btn_close, GroupLayout.PREFERRED_SIZE, 151,
                                                GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(btn_save, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE))))
                .addContainerGap(100, Short.MAX_VALUE)));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup().addContainerGap(28, Short.MAX_VALUE).addComponent(lbl_title)
                        .addGap(18, 18, 18)
    ...
    private void saveAccount() {
        ...
        String fullName = txt_name.getText(), idNumber = txt_id.getText(),
                accountType = String.valueOf(cmb_type.getSelectedItem()), phoneNumber = txt_phone.getText(),
        ...
        if (fullName == null) {
            ...
            try {
                Account account = new Account(balance, fullName, idNumber, accountType, phoneNumber, emai1);
                int reply = JOptionPane.showConfirmDialog(null, "Create account for " + fullName, "Confirm Action",
                        JOptionPane.YES_NO_OPTION);
                if (reply == JOptionPane.YES_OPTION) {
                    JOptionPane.showMessageDialog(this.getParent(), "Account Created Succesfully");
                    editInterFace.onSave(account);
                }
            } catch (InsufficientFundsException ex) {
                JOptionPane.showMessageDialog(this.getParent(), "Below minimun deposit to create account");
            }
        }
