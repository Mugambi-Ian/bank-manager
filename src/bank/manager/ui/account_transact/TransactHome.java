...
public class TransactHome extends JPanel {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout
                ...
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btn_send, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE).addGap(18, 18, 18)
                ...
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbl_date, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE).addGap(6, 6, 6)
