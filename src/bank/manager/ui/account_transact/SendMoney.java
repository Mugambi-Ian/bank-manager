...
public class SendMoney extends JPanel {    
    ...
    private JLabel lbl_id,lbl_name,lbl_phone,
        lbl_send,lbl_title,lbl_type,
           txt_name,txt_phone,txt_type;
    ...
    private void initComponents() {
        ...
        btn_proceed.addActionListener((java.awt.event.ActionEvent evt) -> {
            if(current == null){
                ...
                int reply = JOptionPane.showConfirmDialog(null, "Send amount "+txt_send.getText()+
                        " money from "+main.fullName+ " to " +current.fullName,
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(lbl_send, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(txt_send, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
